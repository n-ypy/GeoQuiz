...
<nav id="topnav">
        ...
        <span><?=$_SESSION['username']?> : <span id="userScore">0 points</span></span>
            ...
            <div class="col">
                ...
                <div class="question">
                    ...
                    <div class="rollover" id="option1"> <!--attention à id="responseOne"-->
                        <button class="btn" onclick="verifyResponse('option1')"></button>
                    </div>
                    <br>
                    <div class="rollover" id="option2"> <!--attention à id="responseTwo"-->
                        <button class="btn" onclick="verifyResponse('option2')"></button>
                    </div>
                    <br>
                    <div class="rollover" id="option3"> <!--attention à id="responseThree"-->
                        <button class="btn" onclick="verifyResponse('option3')"></button>
                    </div>
                    <br>
                    <div class="rollover" id="option4"> <!--attention à id="responseFour"-->
                        <button class="btn" onclick="verifyResponse('option4')"></button>
                    </div>
